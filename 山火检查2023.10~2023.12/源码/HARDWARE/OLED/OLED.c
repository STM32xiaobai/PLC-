...
void OLED_ShowData(void)
{
	...
	OLED_ShowString(0, 9, "Latitude :", OLED_6X8);			//纬度
	OLED_ShowString(0, 17, "Altitude :",OLED_6X8);		//海拔
	OLED_ShowFloatNum(60, 1, gpsx.longitude, 3, 3, OLED_6X8);		//显示经度
	OLED_ShowFloatNum(60, 9, gpsx.latitude, 3, 3, OLED_6X8);		//显示纬度
	OLED_ShowFloatNum(60, 17, gpsx.altitude, 4, 2, OLED_6X8);		//显示海拔
	
	
	OLED_ShowString(0, 25, "Date:", OLED_6X8);				//日期
	OLED_ShowString(0, 33, "Time:", OLED_6X8);				//时间
	
	OLED_ShowNum(28, 25, MyRTC_Time[0], 4, OLED_6X8);		//显示MyRTC_Time数组中的时间值，年
	OLED_ShowString(52, 25, "-", OLED_6X8);
	OLED_ShowNum(58, 25, MyRTC_Time[1], 2, OLED_6X8);		//月
	OLED_ShowString(70, 25, "-", OLED_6X8);
	OLED_ShowNum(77, 25, MyRTC_Time[2], 2, OLED_6X8);		//日
	
	OLED_ShowNum(28, 33, MyRTC_Time[3], 2, OLED_6X8);		//时
	OLED_ShowString(52, 33, "-", OLED_6X8);
	OLED_ShowNum(58, 33, MyRTC_Time[4], 2, OLED_6X8);		//分
	OLED_ShowString(70, 33, "-", OLED_6X8);
	OLED_ShowNum(77, 33, MyRTC_Time[5], 2, OLED_6X8);		//秒
