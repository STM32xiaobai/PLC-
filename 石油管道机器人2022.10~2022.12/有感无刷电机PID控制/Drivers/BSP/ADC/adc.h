...
#define ADC_ADCX_CH0_GPIO_PORT              GPIOA                                               /* 电源电压采集引脚 */
#define ADC_ADCX_CH0_GPIO_PIN               GPIO_PIN_0
#define ADC_ADCX_CH0_GPIO_CLK_ENABLE()      do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)

#define ADC_ADCX_CH1_GPIO_PORT              GPIOA                                               /* 温度采集引脚 */
#define ADC_ADCX_CH1_GPIO_PIN               GPIO_PIN_1
#define ADC_ADCX_CH1_GPIO_CLK_ENABLE()      do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)

#define ADC_ADCX_CH2_GPIO_PORT              GPIOA                                               /* U相采集引脚 */
#define ADC_ADCX_CH2_GPIO_PIN               GPIO_PIN_2
...
#define ADC_ADCX_CH0                        ADC_CHANNEL_0                                       /* 通道Y,  0 <= Y <= 17 */ 
#define ADC_ADCX_CH1                        ADC_CHANNEL_1
#define ADC_ADCX_CH2                        ADC_CHANNEL_2
